...
이 Dirty Checking Lab 위에 쌓는 확장 실험:
- **[JPA/Spring 실무 문제 Lab](../jpa-spring-practicals/README.md)** — N+1, Proxy, OSIV, Batch Insert, Kotlin+JPA, 벌크 UPDATE, 낙관적 락 (이슈 [#18](https://github.com/PreAgile/concurrency-cache-lab/issues/18)~[#24](https://github.com/PreAgile/concurrency-cache-lab/issues/24))
